...
namespace StatSystem.UnityAdapters
{
    ...
    public class ModifierActivePrerequisiteFactory : ScriptableObject
    {
        ...
        protected virtual bool ActivePrerequisite(Modifier.Contexts contexts, Modifier.IExpireTrigger trigger)
        {
